            ...
            >
              ...
              <div className="flex gap-6 sm:gap-8">
                ...
                <motion.div 
                  ...
                  className="flex-1 glass-card rounded-2xl p-6 sm:p-8 hover:border-cyan-400/40 hover:shadow-[0_0_30px_rgba(6,182,212,0.12)] transition-all duration-300 relative overflow-hidden bg-grid-pattern"
                >
